...
rojo y que además su nombre contenga tanto
las letras n Y a, sin importar el orden,
...
export default function contarOvejas(ovejas) {
    let ovejasFiltradas = ovejas
                            .filter(ovejas=> 
                               ovejas.color === 'rojo' && ovejas.name.includes('a')&& ovejas.name.includes('n')
                            || ovejas.color === 'rojo' && ovejas.name.includes('A')&& ovejas.name.includes('n')
                            || ovejas.color === 'rojo' && ovejas.name.includes('a')&& ovejas.name.includes('N'));
